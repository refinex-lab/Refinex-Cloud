...
INSERT INTO `sys_role` (`id`, `is_builtin`, `role_code`, `role_name`, `role_type`, `data_scope`, `priority`, `remark`,
                        `status`)
VALUES (1, 1, 'SUPER_ADMIN', '超级管理员', 1, 1, 1000, '系统最高权限角色', 1);

-- 初始化普通用户角色
INSERT INTO `sys_role` (`id`, `is_builtin`, `role_code`, `role_name`, `role_type`, `data_scope`, `priority`, `remark`,
                        `status`)
VALUES (2, 1, 'ROLE_USER', '普通用户', 0, 3, 100, '默认普通用户角色', 1);
...
(
    ...
    `operation_status`   TINYINT               NOT NULL DEFAULT 0 COMMENT '操作状态:1成功,0失败',
    `error_message`      VARCHAR(500)                   DEFAULT NULL COMMENT '错误信息',
...
(
    ...
    `login_status`   TINYINT               NOT NULL DEFAULT 0 COMMENT '登录状态:1成功,0失败',
