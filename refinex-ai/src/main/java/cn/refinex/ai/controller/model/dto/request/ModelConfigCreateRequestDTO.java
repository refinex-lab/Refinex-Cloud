...
public class ModelConfigCreateRequestDTO {

    @NotBlank(message = "模型编码不能为空")
    @Size(max = 50, message = "模型编码长度不能超过50")
    @Schema(description = "模型编码", example = "QWEN_MAX", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "是否启用:0否,1是", example = "1", requiredMode = Schema.RequiredMode.REQUIRED)
