 ...
 * 七牛云 Kodo 文件存储实现
 * <p>
 * 基于 S3 协议兼容层实现，endpoint 配置为 Kodo 的 S3 兼容端点。
 * 例如：https://s3-cn-east-1.qiniucs.com
 * </p>
 *
 * @author Refinex
 * @since 1.0.0
...
public class KodoFileStorage implements FileStorage {
    ...
    public String upload(InputStream inputStream, String fileName, String contentType, Map<String, String> metadata) {
        try {
            ...
            log.info("文件已上传到七牛云 Kodo，bucket={}, key={}", bucketName, storageKey);
    ...
    public InputStream download(String storageKey) {
        try {
            ...
            log.info("文件已从七牛云 Kodo 下载，bucket={}, key={}", bucketName, key);
            return inputStream;
    ...
    public void delete(String storageKey) {
        try {
            ...
            log.info("文件已从七牛云 Kodo 删除，bucket={}, key={}", bucketName, key);
    ...
    public String generatePresignedUrl(String storageKey, Duration expiration) {
        try {
            ...
            log.info("七牛云 Kodo 预签名 URL 已生成，bucket={}, key={}, expiration={}", bucketName, key, expiration);
            return url;
    ...
    public String initiateMultipartUpload(String fileName, String contentType) {
        try {
            ...
            log.info("七牛云 Kodo 分片上传已初始化，bucket={}, key={}, uploadId={}", bucketName, key, s3UploadId);
    ...
    public String uploadPart(String uploadId, int partNumber, InputStream inputStream) {
        try {
            ...
            log.info("七牛云 Kodo 分片已上传，bucket={}, key={}, partNumber={}, eTag={}", context.getBucketName(), context.getKey(), partNumber, eTag);
            return eTag;
    ...
    public String completeMultipartUpload(String uploadId, List<PartETag> parts) {
        try {
            ...
            log.info("七牛云 Kodo 分片上传已完成，bucket={}, key={}, parts={}", context.getBucketName(), context.getKey(), parts.size());
