 ...
 * S3 文件存储实现
 * <p>
 * 基于 AWS SDK for Java 2.x 实现，兼容 AWS S3、MinIO 等 S3 协议存储。
 * </p>
 *
 * @author Refinex
 * @since 1.0.0
...
public class S3FileStorage implements FileStorage {
    ...
    public String upload(InputStream inputStream, String fileName, String contentType, Map<String, String> metadata) {
        try {
            ...
            log.info("文件已上传到 S3，bucket={}, key={}", bucketName, storageKey);
    ...
    public InputStream download(String storageKey) {
        try {
            ...
            log.info("文件已从 S3 下载，bucket={}, key={}", bucketName, key);
            return inputStream;
    ...
    public void delete(String storageKey) {
        try {
            ...
            log.info("文件已从 S3 删除，bucket={}, key={}", bucketName, key);
    ...
    public String generatePresignedUrl(String storageKey, Duration expiration) {
        try {
            ...
            log.info("预签名 URL 已生成，bucket={}, key={}, expiration={}", bucketName, key, expiration);
            return url;
    ...
    public String initiateMultipartUpload(String fileName, String contentType) {
        try {
            ...
            log.info("分片上传已初始化，bucket={}, key={}, uploadId={}", bucketName, key, s3UploadId);
    ...
    public String uploadPart(String uploadId, int partNumber, InputStream inputStream) {
        try {
            ...
            log.info("分片已上传，bucket={}, key={}, partNumber={}, eTag={}", context.getBucketName(), context.getKey(), partNumber, eTag);
            return eTag;
    ...
    public String completeMultipartUpload(String uploadId, List<PartETag> parts) {
        try {
            ...
            log.info("分片上传已完成，bucket={}, key={}, parts={}", context.getBucketName(), context.getKey(), parts.size());
