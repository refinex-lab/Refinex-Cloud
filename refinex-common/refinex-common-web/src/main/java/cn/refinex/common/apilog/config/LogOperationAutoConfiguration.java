...
public class LogOperationAutoConfiguration implements WebMvcConfigurer {
    ...
    public FilterRegistrationBean<LogOperationFilter> logOperationFilter(WebProperties webProperties, @Value("${spring.application.name}") String applicationName, LogOperationServiceClient logOperationClient) {
