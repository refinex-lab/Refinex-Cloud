...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "目录响应DTO")
public class ContentDirectoryResponseDTO {
    ...
    private List<ContentDirectoryResponseDTO> children;

    @Schema(description = "是否有子目录", example = "true")
