...
import cn.refinex.platform.domain.dto.request.DictTypeCreateRequest;
import cn.refinex.platform.domain.dto.request.DictTypeUpdateRequest;
import cn.refinex.platform.domain.dto.request.DictDataCreateRequest;
import cn.refinex.platform.domain.dto.request.DictDataUpdateRequest;
...
public class SysDictController {
    ...
    public ApiResult<Long> createDictType(@Valid @RequestBody DictTypeCreateRequest req) {
    ...
    public ApiResult<Boolean> updateDictType(@PathVariable("id") Long id, @Valid @RequestBody DictTypeUpdateRequest req) {
        Long operatorId = StpUtil.getLoginIdAsLong();
    ...
    public ApiResult<Long> createDictData(@Valid @RequestBody DictDataCreateRequest req) {
        Long operatorId = StpUtil.getLoginIdAsLong();
    ...
    public ApiResult<Boolean> updateDictData(@PathVariable("id") Long id, @Valid @RequestBody DictDataUpdateRequest req) {
        Long operatorId = StpUtil.getLoginIdAsLong();
