...
public class SysPermissionController {
    ...
    public ApiResult<Long> createPermission(@Valid @RequestBody SysPermissionCreateRequest request) {
    ...
    public ApiResult<Boolean> updatePermission(@PathVariable Long id, @Valid @RequestBody SysPermissionUpdateRequest request) {
    ...
    @Parameter(name = "id", description = "权限 ID", required = true)
    public ApiResult<SysPermissionResponse> getPermission(@PathVariable Long id) {
    ...
    public ApiResult<PageResult<SysPermissionResponse>> searchPermissions(
            @RequestBody SysPermissionQueryRequest query,
