...
import cn.refinex.platform.service.mail.PlatformEmailTemplateService;
...
@Slf4j
@RestController
@RequestMapping("/platform/email/template")
@RequiredArgsConstructor
@Tag(name = "邮件模板管理", description = "邮件模板管理接口")
public class EmailTemplateController {

    private final PlatformEmailTemplateService templateService;
    ...
    public ApiResult<Boolean> updateTemplate(
        ...
        boolean success = templateService.updateTemplate(templateDTO);
    ...
    public ApiResult<EmailTemplate> getTemplateByCode(
        ...
        EmailTemplate template = templateService.getTemplateByCode(code);
        return ApiResult.success(template);
    }
    ...
    public ApiResult<List<EmailTemplate>> getAllAvailableTemplates() {
        List<EmailTemplate> templates = templateService.getAllAvailableTemplates();
    ...
    public ApiResult<String> previewTemplate(
        ...
        String content = templateService.previewTemplate(code, variables);
