...
import cn.refinex.auth.client.user.dto.UserInfoDTO;
import cn.refinex.common.domain.ApiResult;
import cn.refinex.common.security.util.SecurityUtils;
import cn.refinex.platform.controller.user.dto.UserCreateRequest;
import cn.refinex.platform.controller.user.dto.UserUpdateRequest;
import cn.refinex.platform.controller.user.dto.UserVO;
...
public class UserController {
    ...
    @GetMapping("/userinfo")
    @Operation(summary = "根据当前登录用户获取用户信息")
